...
public fun MutableMultiArray<Float, D3>.toImage(colorMode: ColorMode): BufferedImage {
...
internal class MkDataBuffer(internal val ndArray: MutableMultiArray<Float, D3>) : DataBuffer(TYPE_FLOAT, ndArray.size) {
